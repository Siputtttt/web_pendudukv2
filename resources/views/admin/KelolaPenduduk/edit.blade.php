    ...
    <main>
        <div class="container-fluid pt-5 px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="container">
                        <form action="{{ route('kelolaPenduduk.update', $data->nik) }}" method="post"
                            ...
                            <div class="form-group mt-2">
                                <button type="submit" class="btn btn-success mb-3"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
                                <a href="{{ url('/kelolaPenduduk') }}" class="btn btn-danger mb-3"><i
